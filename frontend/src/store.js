...
export default createStore({
  ...
  actions: {
    fetchMenus({ commit }) {
      return axios.get('http://127.0.0.1:8000/api/menus/')
        .then(response => {
    ...
    addMenu({ commit }, menuData) {
      return axios.post('http://127.0.0.1:8000/api/menus/', menuData)
        .then(response => {
    ...
    fetchMenuItems({ commit }) {
      return axios.get('http://127.0.0.1:8000/api/menu-items/')
        .then(response => {
    ...
    addMenuItem({ commit }, menuItemData) {
      return axios.post('http://127.0.0.1:8000/api/menu-items/', menuItemData)
        .then(response => {
    ...
    updateMenuItem({ commit }, { id, data }) {
      return axios.put(`http://127.0.0.1:8000/api/menu-items/${id}/`, data)
        .then(response => {
    ...
    deleteMenuItem({ commit }, menuItemId) {
      return axios.delete(`http://127.0.0.1:8000/api/menu-items/${menuItemId}/`)
        .then(() => {
